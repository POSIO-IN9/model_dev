...
def main(args):
    ...
    # 데이터셋에 따라서 평가할 베이스 데이터셋 선택
    if args.dataset_file == "coco_panoptic":
        # panoptic 학습 시에는 원래의 COCO 데이터셋으로 AP를 계산합니다.
    ...
    if args.resume:
        ...
        # pretrained weights를 로드하고 optimizer와 scheduler를 업데이트합니다.
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # LR 감소 전과 매 100 에폭마다 추가적인 체크포인트 저장
